...
def moment_page():
    """A moment-based ticking clock page (exercises reflex-components-moment)."""
    return rx.center(
        rx.vstack(
            rx.heading("Moment clock", size="6"),
            rx.moment(
                interval=1000,
                format="HH:mm:ss",
                tz=State.valid_zone,
...
app.add_page(moment_page, route="/moment", title="Moment Clock")
