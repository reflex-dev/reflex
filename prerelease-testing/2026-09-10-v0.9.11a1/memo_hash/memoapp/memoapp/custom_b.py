"""Module B: four custom components whose qualnames match module A's exactly.
...
class CodeWidget(rx.el.Div):
    ...
    def add_custom_code(self) -> list[str]:
        ...
        Returns:
            The custom code.
        """
        return ["globalThis.MEMO_CODE_B = 'code-B';"]
...
class DynWidget(rx.el.Div):
    ...
    def _get_dynamic_imports(self) -> str:
        ...
        """
        return "const MEMO_DYN_B = (globalThis.MEMO_DYN_B = 'dyn-B');"
...
class WrapWidget(rx.el.Div):
    ...
    def _get_app_wrap_components():
        ...
        Returns:
            The app wrap dict.
        """
        return {(62, "MemoWrapB"): rx.text("bbbbb")}
