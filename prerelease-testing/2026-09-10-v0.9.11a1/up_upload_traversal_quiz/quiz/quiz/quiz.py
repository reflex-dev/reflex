...
from .shiki_page import shiki_page  # ADDED for the upgrade test (shiki 4.4.3 bump coverage)
...
# ADDED for the upgrade test: rx._x.code_block (shiki) coverage, see shiki_page.py
app.add_page(shiki_page, route="/shiki", title="Shiki blocks")
