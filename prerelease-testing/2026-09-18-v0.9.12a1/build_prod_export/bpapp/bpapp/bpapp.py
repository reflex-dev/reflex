...
if os.environ.get("BP_SENTRY") == "1":
    import sentry_sdk
    from sentry_sdk.integrations.starlette import StarletteIntegration

    sentry_sdk.init(
        dsn="http://k@localhost:1/1",
        integrations=[StarletteIntegration(), StarletteIntegration()],
    )
...
if os.environ.get("BP_BUNDLE", "1") == "1":
    bundle_library(rx.icon("rocket"))
