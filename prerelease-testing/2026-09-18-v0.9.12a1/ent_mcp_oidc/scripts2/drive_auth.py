...
IDP = "http://localhost:" + (sys.argv[3] if len(sys.argv) > 3 else "9899")
...
path = f"/tmp/claude-0/-home-user-reflex/4bc251b7-1728-51b6-97f5-dc5c7f35130a/scratchpad/apps/ent_mcp_oidc/logs/auth_{LABEL}.json"
