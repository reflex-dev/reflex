...
# QA STUB: the upstream CSV URL is blocked by this environment's egress proxy,
# so the same columns are read from a locally generated file instead.
import pathlib
nba_overview = str(pathlib.Path(__file__).resolve().parents[2] / "nba_local.csv")
