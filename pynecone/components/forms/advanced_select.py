...
class AdvancedSelect(Component):
    ...
    def get_alias(cls) -> str:
        """Avoid conflict with default Chakra Select.
    ...
    @classmethod
    def create(
        cls, options: List[Component | str | int | float | bool], **props
    ) -> Component:
        """Takes a list of options and additional properties, checks if each option is an
        instance of AdvancedOption, and returns a Select component with the given options and
