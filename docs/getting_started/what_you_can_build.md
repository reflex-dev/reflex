...
| A model or media interface | [Model and media interfaces](/docs/guides/model-and-media-interfaces/) | Local inference plus image and audio upload, processing, preview, and download workflows |
