...
See the [download event reference](/docs/api-reference/special-events/#rx.download).
...
For detailed information, see the [upload component reference](/docs/library/forms/upload/).
