...
```python demo
rx.image(src="https://web.reflex-assets.dev/other/Reflex.svg", alt='Reflex logo', width="5em")
```
...
def my_component_with_image():
    return rx.image(src=rx.asset("image.png", shared=True, subfolder="images"), alt='Example image asset')
```
