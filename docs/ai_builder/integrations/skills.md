...
def _summary_card(kicker: str, title: str, body: str) -> rx.Component:
    return rx.el.div(
        rx.el.div(
            kicker, class_name="text-xs font-semibold uppercase text-primary-hover"
        ),
        ...
        class_name="flex flex-col gap-2 rounded-lg border border-border-subtle bg-white-1 p-4",
    )
