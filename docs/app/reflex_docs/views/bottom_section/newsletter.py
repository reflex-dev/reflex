...
def newsletter_input() -> rx.Component:
            ...
            rx.box(
                rx.box(
                    ...
                    rx.text(
                        ...
                        class_name="font-base text-muted-foreground",
                    ),
  ...
  <defs>
    <radialGradient id="paint0_radial_10744_8734" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(200 44.5) rotate(90) scale(44.5 200)">
      ...
      <stop offset="1" stop-color="var(--muted)" stop-opacity="0"/>
    </radialGradient>
  </defs>
</svg>""",
                    ...
                    rx.el.input(
                        ...
                        name="input_email",
                        type="email",
                        class_name="relative box-border border-border-subtle focus:border-border-strong focus:border-1 bg-muted p-[0.5rem_0.75rem] border rounded-xl font-base text-muted-foreground placeholder:text-subtle-foreground outline-none focus:outline-none w-full",
                    ),
...
def newsletter_card() -> rx.Component:
    return rx.box(
        rx.box(
            rx.el.h2("Newsletter", class_name="font-large text-foreground"),
            rx.el.p(
                """Get the latest updates and news about Reflex""",
                class_name="font-base text-muted-foreground whitespace-pre",
            ),
