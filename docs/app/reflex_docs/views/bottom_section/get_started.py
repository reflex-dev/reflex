      ...
      <stop offset="1" stop-color="var(--background)" stop-opacity="0"/>
        ...
        rx.box(
            rx.box(
                ...
                rx.el.p("$ reflex init"),
                rx.el.p("$ reflex run"),
                class_name="font-['JetBrains_Mono'] !font-semibold text-[0.8125rem] text-foreground leading-6 tracking-[-0.01219rem]",
            ),
            hint(
                text="Copy",
                content=rx.el.button(
                    ...
                    class_name="cursor-pointer self-baseline h-fit p-2 rounded-[0.625rem] hover:bg-accent transition-bg",
