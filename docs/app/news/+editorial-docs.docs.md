...
Make the component library easier to scan with baseline-aligned, text-only category headings on a uniform background, fine dividers, and component links arranged in columns with subtle hover highlights.
