...
from reflex_base.components import dynamic as dynamic_components
...
# Older reflex-base versions only expose the public registration helper.
_bundle_library = getattr(
