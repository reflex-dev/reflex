    ...
    return rx.el.div(
        rx.el.div(
            rx.el.span(
                ...
                class_name="text-foreground lg:text-3xl text-2xl font-[575]",
            ),
            rx.el.span(
                "Describe your idea, and let AI transform it into a complete, production-ready Python web application.",
                class_name="text-muted-foreground text-sm font-medium",
            ),
            rx.el.div(
                rx.el.elements.a(
                    marketing_button(
        ...
        class_name="flex flex-row justify-between max-w-(--landing-layout-max-width) mx-auto w-full bg-white-1 backdrop-blur-[16px] rounded-xl relative overflow-hidden shadow-[0_0_0_1px_rgba(0,0,0,0.04),0_12px_24px_0_rgba(0,0,0,0.08),0_1px_1px_0_rgba(0,0,0,0.01),0_4px_8px_0_rgba(0,0,0,0.03)] dark:shadow-none dark:border dark:border-border-subtle pl-16 max-lg:hidden mb-12 mt-24",
    )
