# Generated from packages/reflex-build-sdk/src/reflex_build_sdk/_async/resources/connections.py by packages/reflex-build-sdk/scripts/unasync.py. Do not edit.
...
class Connections:
    ...
    def providers(self) -> builtins.list[ConnectionProvider]:
    ...
    def disconnect(
        ...
        *,
        ...
        """
        if end_user is None:
            self._client._request("DELETE", self._path(app_id, provider), None)
            return
