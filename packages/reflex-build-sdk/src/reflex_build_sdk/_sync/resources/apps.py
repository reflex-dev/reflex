# Generated from packages/reflex-build-sdk/src/reflex_build_sdk/_async/resources/apps.py by packages/reflex-build-sdk/scripts/unasync.py. Do not edit.
...
class Apps:
    ...
    def create(
        ...
        *,
        ...
        # The response only identifies the app, so the app is read back in full.
