...
def _h1(value: object):
    from reflex_radix.themes.typography.heading import Heading
...
def _ul(value: object):
    from reflex_radix.themes.layout.list import UnorderedList

    return UnorderedList.create(value, margin_y="1em")


def _ol(value: object):
    from reflex_radix.themes.layout.list import OrderedList

    return OrderedList.create(value, margin_y="1em")


def _li(value: object):
    from reflex_radix.themes.layout.list import ListItem

    return ListItem.create(value, margin_y="0.5em")


def _a(value: object):
    from reflex_radix.themes.typography.link import Link

    return Link.create(value)


def _code(value: object):
    from reflex_radix.themes.typography.code import Code
