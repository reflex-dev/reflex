# Generated from packages/reflex-sdk/src/reflex_sdk/_async/resources/deployments.py by scripts/unasync_reflex_sdk.py. Do not edit.
...
class Deployments:
    ...
    def _upload(
        ...
        """
        uploader = ArchiveUploader(self._client._transport, on_progress)
