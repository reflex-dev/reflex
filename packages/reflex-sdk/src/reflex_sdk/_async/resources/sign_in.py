...
class AsyncSignIn:
    ...
    async def get(self, app_id: uuid.UUID | str) -> SignInStatus:
        ...
        """
        return await self._client._request("GET", self._path(app_id), SignInStatus)

    async def enable(self, app_id: uuid.UUID | str) -> SignInStatus:
        ...
        """
        enabled = await self._client._request(
    ...
    async def disable(self, app_id: uuid.UUID | str) -> bool:
        ...
        """
        disabled = await self._client._request(
            "DELETE", self._path(app_id), _SignInDisabled
        )
    ...
    async def export_users(self, app_id: uuid.UUID | str) -> EndUserExport:
    ...
    async def get_audience(self, app_id: uuid.UUID | str) -> Audience:
        ...
        """
        return await self._client._request(
            "GET", self._path(app_id, "/audience"), Audience
        )
    ...
    async def invite(self, app_id: uuid.UUID | str, email: str) -> SignInInvite:
    ...
    async def uninvite(self, app_id: uuid.UUID | str, email: str) -> InviteRemoval:
