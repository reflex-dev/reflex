...
class AsyncEnvironments:
    ...
    async def list(self, app_id: uuid.UUID | str) -> builtins.list[Environment]:
    ...
    async def enable(self, app_id: uuid.UUID | str) -> EnvironmentsEnabled:
    ...
    async def copy_missing_secrets(
