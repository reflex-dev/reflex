...
def test_create_reflex_dir(mocker, is_windows):
    ...
    mocker.patch("reflex.utils.prerequisites.install_node")
    mocker.patch("reflex.utils.prerequisites.install_bun")
    mocker.patch("reflex.utils.prerequisites.validate_bun")
    mocker.patch("reflex.utils.prerequisites.validate_node")
