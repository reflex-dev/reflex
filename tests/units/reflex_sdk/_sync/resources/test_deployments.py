# Generated from tests/units/reflex_sdk/_async/resources/test_deployments.py by packages/reflex-sdk/scripts/unasync.py. Do not edit.
...
def test_wait_checks_the_recorded_state_periodically(
    ...
    monkeypatch.setattr("reflex_sdk._sync.resources.deployments._REPORT_EVERY_POLLS", 3)
