...
def test_cond_assert_types() -> None:
    ...
    _ = assert_type(cond(True, 1, 2), Var[int])  # ty:ignore[type-assertion-failure]
    ...
    # Var[T], U -> Var[T | U]
    _ = assert_type(cond(True, widened_var_str, 3), Var[str | int])  # ty:ignore[type-assertion-failure]
