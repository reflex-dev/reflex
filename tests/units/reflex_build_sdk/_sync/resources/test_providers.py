# Generated from tests/units/reflex_build_sdk/_async/resources/test_providers.py by packages/reflex-build-sdk/scripts/unasync.py. Do not edit.
...
def test_connect_gcp(client: ReflexBuild, mock_api: MockAPI):
    ...
    assert client.providers.connect_gcp(
        ORG_ID,
...
def test_gcp_blocking_apps(client: ReflexBuild, mock_api: MockAPI):
    ...
    assert client.providers.gcp_blocking_apps(ORG_ID) == [
        GcpBlockingApp(
...
def test_gcp_connections_create(client: ReflexBuild, mock_api: MockAPI):
    ...
    assert (
        client.providers.gcp_connections.create(
            ORG_ID,
            "staging",
...
def test_gcp_connections_rotate_key(client: ReflexBuild, mock_api: MockAPI):
    ...
    assert client.providers.gcp_connections.rotate_key(
...
def test_gcp_connections_verify(client: ReflexBuild, mock_api: MockAPI):
    ...
    assert client.providers.gcp_connections.verify(
        ORG_ID, ACCOUNT_ID
    ) == GcpVerification(
        ok=False,
        connection_name="default",
...
def test_gcp_connections_delete(client: ReflexBuild, mock_api: MockAPI):
    ...
    assert client.providers.gcp_connections.delete(ORG_ID, ACCOUNT_ID) is None
