...
import pytest
from reflex_build_sdk._decode import DecodeError, _decoder_for, decode, json_name
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (int | str, "a", "a"),
        (tuple[list[int], str | None], [[1], None], ([1], None)),
    ],
)
