...
def test_event_provider_app_wrap_order(mocker: MockerFixture) -> None:
    ...
    state_index = root_contents.index("jsx(StateProvider")
    event_loop_index = root_contents.index("jsx(EventLoopProvider")
    app_wrap_index = root_contents.index("jsx(AppWrap")
    assert state_index < event_loop_index < app_wrap_index
