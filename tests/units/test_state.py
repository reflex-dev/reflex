...
async def test_get_state_mixin(clean_registration_context):
    ...
    root = MixinRootState(_reflex_internal_init=True)  # pyright: ignore [reportCallIssue]
...
async def test_get_state_mixin_ambiguous(clean_registration_context):
    ...
    root = AmbiguousRootState(_reflex_internal_init=True)  # pyright: ignore [reportCallIssue]
