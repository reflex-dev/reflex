...
def test_frontend_computed_var_names_precomputed():
    """Classes precompute which computed vars are sent to the frontend."""
    ...
    assert FrontendCvarState._frontend_computed_var_names == {"visible"}
