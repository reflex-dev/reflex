...
class BaseConfig:
    ...
    Attributes:
        ...
        extra_overlay_function: Extra overlay function to run after the app is built. Formatted such that `from path_0.path_1... import path[-1]`, and calling it with no arguments would work. For example, "reflex_moment.moment".
