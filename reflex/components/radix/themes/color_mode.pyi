...
position_map = {'position': position_values, 'left': ['top-left', 'bottom-left'], 'right': ['top-right', 'bottom-right'], 'top': ['top-left', 'top-right'], 'bottom': ['bottom-left', 'bottom-right']}

class ColorModeIconButton(IconButton):

    @overload
    @classmethod
    def create(cls, *children, position: Optional[Literal['top-left', 'top-right', 'bottom-left', 'bottom-right']]=None, allow_system: Optional[bool]=False, as_child: Optional[Union[Var[bool], bool]]=None, size: Optional[Union[Var[Union[Breakpoints[str, Literal['1', '2', '3', '4']], Literal['1', '2', '3', '4']]], Literal['1', '2', '3', '4'], Breakpoints[str, Literal['1', '2', '3', '4']]]]=None, variant: Optional[Union[Var[Literal['classic', 'solid', 'soft', 'surface', 'outline', 'ghost']], Literal['classic', 'solid', 'soft', 'surface', 'outline', 'ghost']]]=None, color_scheme: Optional[Union[Var[Literal['tomato', 'red', 'ruby', 'crimson', 'pink', 'plum', 'purple', 'violet', 'iris', 'indigo', 'blue', 'cyan', 'teal', 'jade', 'green', 'grass', 'brown', 'orange', 'sky', 'mint', 'lime', 'yellow', 'amber', 'gold', 'bronze', 'gray']], Literal['tomato', 'red', 'ruby', 'crimson', 'pink', 'plum', 'purple', 'violet', 'iris', 'indigo', 'blue', 'cyan', 'teal', 'jade', 'green', 'grass', 'brown', 'orange', 'sky', 'mint', 'lime', 'yellow', 'amber', 'gold', 'bronze', 'gray']]]=None, high_contrast: Optional[Union[Var[bool], bool]]=None, radius: Optional[Union[Var[Literal['none', 'small', 'medium', 'large', 'full']], Literal['none', 'small', 'medium', 'large', 'full']]]=None, auto_focus: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, disabled: Optional[Union[Var[bool], bool]]=None, form: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, form_action: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, form_enc_type: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, form_method: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, form_no_validate: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, form_target: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, name: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, type: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, value: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, access_key: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, auto_capitalize: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, content_editable: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, context_menu: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, dir: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, draggable: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, enter_key_hint: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, hidden: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, input_mode: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, item_prop: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, lang: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, role: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, slot: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, spell_check: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, tab_index: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, title: Optional[Union[Var[Union[bool, int, str]], str, int, bool]]=None, loading: Optional[Union[Var[bool], bool]]=None, style: Optional[Style]=None, key: Optional[Any]=None, id: Optional[Any]=None, class_name: Optional[Any]=None, autofocus: Optional[bool]=None, custom_attrs: Optional[Dict[str, Union[Var, str]]]=None, on_blur: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_click: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_context_menu: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_double_click: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_focus: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_mount: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_mouse_down: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_mouse_enter: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_mouse_leave: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_mouse_move: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_mouse_out: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_mouse_over: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_mouse_up: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_scroll: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, on_unmount: Optional[Union[EventHandler, EventSpec, list, Callable, BaseVar]]=None, **props) -> 'ColorModeIconButton':
