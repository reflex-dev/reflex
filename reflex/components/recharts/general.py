...
class GraphingTooltip(Recharts):
    ...
    separator: ImmutableVar[str]

    # The offset size of tooltip. Number
    offset: ImmutableVar[int]

    # When an item of the payload has value null or undefined, this item won't be displayed.
    filter_null: ImmutableVar[bool]

    # If set false, no cursor will be drawn when tooltip is active.
    cursor: ImmutableVar[Union[Dict[str, Any], bool]] = LiteralVar.create(
        {
            "strokeWidth": 1,
            "fill": Color("gray", 3),
        }
    ...
    view_box: ImmutableVar[Dict[str, Any]]

    # The style of default tooltip content item which is a li element. DEFAULT: {}
    item_style: ImmutableVar[Dict[str, Any]] = LiteralVar.create(
        {
            "color": Color("gray", 12),
        }
    )
    ...
    wrapper_style: ImmutableVar[Dict[str, Any]]
    # The style of tooltip content which is a dom element. DEFAULT: {}
    content_style: ImmutableVar[Dict[str, Any]] = LiteralVar.create(
        {
...
class Label(Recharts):
    ...
    position: ImmutableVar[LiteralPosition]
...
class LabelList(Recharts):
    ...
    fill: ImmutableVar[Union[str, Color]] = LiteralVar.create(Color("gray", 10))

    # The stroke color of each label
    stroke: ImmutableVar[Union[str, Color]] = LiteralVar.create("none")
