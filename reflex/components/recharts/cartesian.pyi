...
class Axis(Recharts):
    ...
    def create(  # type: ignore
        ...
        *children,
        ...
        domain: Optional[Union[Sequence, Var[Sequence]]] = None,
        ...
        ticks: Optional[
            Union[Sequence[Union[int, str]], Var[Sequence[Union[int, str]]]]
        ] = None,
...
class ZAxis(Recharts):
    ...
    def create(  # type: ignore
        ...
        *children,
        ...
        range: Optional[Union[Sequence[int], Var[Sequence[int]]]] = None,
        unit: Optional[Union[Var[Union[int, str]], int, str]] = None,
        name: Optional[Union[Var[Union[int, str]], int, str]] = None,
        scale: Optional[
            Union[
...
class Brush(Recharts):
    ...
    def create(  # type: ignore
        ...
        *children,
        ...
        data: Optional[Union[Sequence[Any], Var[Sequence[Any]]]] = None,
...
class Area(Cartesian):
    ...
    def create(  # type: ignore
        ...
        *children,
        ...
        base_line: Optional[
            Union[
                Sequence[Dict[str, Any]], Var[Union[Sequence[Dict[str, Any]], str]], str
            ]
        ] = None,
        points: Optional[
            Union[Sequence[Dict[str, Any]], Var[Sequence[Dict[str, Any]]]]
        ] = None,
...
class Bar(Cartesian):
    ...
    def create(  # type: ignore
        ...
        *children,
        ...
        radius: Optional[
            Union[Sequence[int], Var[Union[Sequence[int], int]], int]
        ] = None,
        layout: Optional[
            Union[
                Literal["horizontal", "vertical"],
...
class ReferenceLine(Reference):
    ...
    def create(  # type: ignore
        ...
        *children,
        ...
        segment: Optional[Sequence[Any]] = None,
        x_axis_id: Optional[Union[Var[Union[int, str]], int, str]] = None,
        y_axis_id: Optional[Union[Var[Union[int, str]], int, str]] = None,
        if_overflow: Optional[
            Union[
