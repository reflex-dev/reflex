...
LiteralPosition = Literal['top-left', 'top-center', 'top-right', 'bottom-left', 'bottom-center', 'bottom-right']
...
class ToastNamespace(ComponentNamespace):
    ...
    @staticmethod
    def __call__(message: str, level: Optional[str]=None, **props) -> 'Optional[EventSpec]':
