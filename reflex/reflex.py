...
def _require_db_extra():
    """Exit with an install hint when the packages from the db extra are missing.

    Raises:
        Exit: If sqlalchemy, sqlmodel or alembic is not installed.
    """
    # Without these, the model imports below fail with a raw ModuleNotFoundError.
