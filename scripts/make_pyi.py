...
DEFAULT_TARGETS = [
    ...
    "reflex/experimental",
    "reflex/__init__.py",
    "packages/reflex-code/src/reflex_code",
    "packages/reflex-components/src/reflex_components",
    "packages/reflex-dataeditor/src/reflex_dataeditor",
    "packages/reflex-gridjs/src/reflex_gridjs",
    "packages/reflex-lucide/src/reflex_lucide",
    "packages/reflex-markdown/src/reflex_markdown",
    "packages/reflex-moment/src/reflex_moment",
