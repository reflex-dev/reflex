...
Our DALL·E. app has an event handlers, `get_image` to which get this image from the openai api. Using yield in the middle of an event handler will cause the UI to update. Otherwise the UI will update at the end of the event handler.
